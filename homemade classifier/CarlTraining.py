...
pickle.dump(words, open("homemade classifier/Pickles and models/words.pkl", "wb"))
pickle.dump(classes, open("homemade classifier/Pickles and models/classes.pkl", "wb"))
...
model.save("homemade classifier/Pickles and models/Carl_bot.model", hist)
